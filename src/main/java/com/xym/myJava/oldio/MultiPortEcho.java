...
public class MultiPortEcho {
    ...
    public static void main(String[] args) throws IOException {
        args = new String[]{"9001", "9002", "9003"};
        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                if ((key.readyOps() & SelectionKey.OP_ACCEPT) == SelectionKey.OP_ACCEPT) {
                    ...
                    CharBuffer charBuffer = decoder.decode(echoBuffer);
                    //sc.write(echoBuffer);
                    System.out.println("Echoed " + bytesEchoed + " from " + sc);
                    System.out.println("data=" + charBuffer.toString());
                    key.attach("ack syn..." + sc.getRemoteAddress());
